...
public class DossierNewReceivedSearch extends SearchContainer<Dossier> {
	 ...
	 * @param iteratorURL
	 */
	public DossierNewReceivedSearch(
	    PortletRequest portletRequest, int delta, PortletURL iteratorURL) {
		
		super(portletRequest, new DossierDisplayTerms(portletRequest), new DossierNewReceivedSearchTerms(
